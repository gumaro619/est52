...
@section('content_header')
    ...
    <p style="text-align: center;" class="fs-5">Sistema integral de información de la EST 52 ->
        <b>{{ $tutor->persona->apellido_p }} {{ $tutor->persona->apellido_m ?? '' }} {{ $tutor->persona->nombre[0] }}.</b>
    </p>
@stop
            ...
            <div class="row">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">¿Los datos de contacto con que cuenta la escuela son de suma importancia como  vía principal de comunicación en caso de emergencias</p>
